...
! 25 May 2014: usymlqCheckModule.f90 derived from lsqrCheckModule.f90.
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

module usymlqCheckModule

  use  usymlqDataModule,    only : ip, dp
  use  usymlqblasInterface, only : ddot, dnrm2, dscal
  implicit none
  private
...
contains
  ...
  subroutine Acheck( m, n, Aprod1, Aprod2, nout, inform )
    ...
    !-------------------------------------------------------------------
    ! One-liner: Acheck checks Aprod1 and Aprod2 for USYMLQ.
    !
    ! Purpose:   Acheck tests the user subroutines Aprod1 and Aprod2
    !   called by USYMLQ.  For some m x n matrix A,
 ...
 1020 format(1p, &
  ...
  subroutine xcheck( m, n, Aprod1, Aprod2, b, damp, x, &
    ...
    ! the vector x and the least-squares problem solved by USYMLQ.
